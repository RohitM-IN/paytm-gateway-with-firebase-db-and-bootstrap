            ...
            <div class="container-fluid"><a class="navbar-brand" href="#"><i
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav ml-auto">
                        <li role="presentation" class="nav-item"><a class="nav-link active" style="color:#ffffff;"
                        ...
                        <li role="presentation" id="out" class="nav-item"><a class="nav-link" style="color:#ffffff;"
                                href="login.php"><i id="inorout_class" class="fa fa-sign-out"></i> Admin</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                    ...
                    <div class="regForm ">
                        ...
                        <form action="pgRedirect.php" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="ORDER_ID" name="ORDER_ID" maxlength="32"
                                    value="<?php echo  uniqid("OID")?>" readonly>
                            </div>
                            <div class="form-group">
                                <label class="unselectable">Full Name:</label>
                                <input type="text" class="form-control is-invalid" id="DONOR_NAME" name="DONOR_NAME"
                                    maxlength="32" placeholder="Enter Full Name" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control is-invalid" id="MOBILE_NUMBER"
                                    name="MOBILE_NUMBER" maxlength="10" placeholder="Ex. 7777777777" required>
                            ...
                            <div class="form-group d-none">
                                <label>Channel</label>
                                <input type="text" class="form-control" id="CHANNEL_ID" name="CHANNEL_ID" value="WEB"
                                    readonly>
                            </div>
                            <div class="form-group d-none">
                                <label>INDUSTRY TYPE ID</label>
                                <input type="text" class="form-control" id="INDUSTRY_TYPE_ID" name="INDUSTRY_TYPE_ID"
                                    value="Retail" readonly>
                            </div>
                            <div class="form-group">
                                <label class="unselectable">Email:</label>
                                <input type="email" class="form-control is-invalid " id="EMAIL_ID" name="EMAIL_ID"
                                    maxlength="32" placeholder="Enter Email" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="TXN_AMOUNT" name="TXN_AMOUNT" min="1"
                                    placeholder="Indian Rupees (INR)" required>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label unselectable" for="Anonymous">Remain
                                                Anonymous</label>
                                        </div>
                                    </div>
                                </div>
