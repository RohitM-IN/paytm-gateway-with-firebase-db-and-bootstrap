...
<html>
<head>
<title>Donate - Garib Pathshala</title>
	...
	<div class="modal-confirm bg-light" style="padding-top: 100px;">
		<div class="">
			...
			<div class="modal-body">
				<p class="text-center">Your Order id <?php echo $_POST['ORDERID'] ?> with Rs <?php echo $_POST['TXNAMOUNT']?>/- has been <?php echo $message . $date ?>.</p>
			</div>
			<div class="modal-footer">
				<a type="button" class="btn btn-block" style="background: <?php echo $color ?>" href="<?php echo $link ?>"><?php echo $button ?></a>
			</div>
		</div>
	</div>  
<!-- > 
...
<script src="./js/firestore.js">submitForm()</script>
